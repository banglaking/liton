...
" ❤ ʌɗɗ cɭʑ 😾 {{•ɱʋѕʈ•}} ❤ ",
" ❤ ŋıcə Pσхʈ ! ❤ ",
" ❤ ɣөʋɽ Pөxʈ 😯 ɭıƙҽɖ ɮɣ <me> ❤ ",
);

$ABCNomer=array(
array(
" ❤ ͼɭөʂҽ ɮαͼƙ ❤ ",
" Pөƙҽ ɱҽ 🎈 ɭıƙҽx ɮɭөͼƙҽɖ 😒💔 ",
" ɣөʋ αɽҽ ʛөөɖ. ❤ ",
),
array(
" 😗❤ Lөѵɘ ƴɘww 🎈 <name> 😗❤ ",
" ❤ ɣөʋɽ Pөxʈ 😯 ɭıƙҽɖ ɮɣ <me> ❤ ",
" ❤ Yөʋ ƙŋөw 😯 ɣөʋɽ αll Pөsʈ ʈөʋcӈəd 😘 ʈө ɱααӈ ӈəαɽʈ. 🎈 ",
),
array(
"  ʂıɭҽŋͼҽ 😯 ıʂ ʈӈҽ ɱөʂʈ 🎈 ɭөʋɖ ѵөıͼҽ. ❤ ",
" ı ҽ'ɱ 🙂 ʛөөɖ ɮөɣ wıʈӈ 🎈 αɭөʈ'x өƒ ɮαɖ ӈαɮıʈx. 😈 ",
" Dɽҽαɱʂ 👑 ɖөŋ'ʈ wөɽƙ ʋŋɭҽʂʂ 🎈 ɣөʋ ɖө. ❤ ",
),
array(
" ❤ ı ɭıƙҽ ɣөʋɽ Pөxʈ. ❤ ",
" ƒҽҽɭ ʈӈҽ Pөwҽɽ 💪 өƒ Ӈαͼʞəʀх ɮөʈ ʈəαɱ. 😈 ",
" ❤ Yөʋ ƙŋөw 😯 ɣөʋɽ αll Pөsʈ ʈөʋcӈəd 😘 ʈө ɱααӈ ӈəαɽʈ.🎈 ",
));
...
return '💜'.$jam.' ӈαѵҽ α ɮҽαʋʈıƒʋɭ ʈıɱҽ 🐣 '.$name.' 💜
